...
describe('PokemonPage component', () => {
    ...
    test('de de llamar mixPokemonArray al montar', () => {
    ...
    test('de de hacer match con el snapshot cuando cargan los pokemons', () => {
    ...
    test('debe de mostrar los componentes de PokemonPicture y PokemonOptions', () => {
        ...
        // PokemonOptions atributte pokemons toBe true
